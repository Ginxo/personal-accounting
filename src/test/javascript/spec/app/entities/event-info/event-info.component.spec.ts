...
import { EventInfoComponent } from 'app/entities/event-info/event-info.component';
...
describe('Component Tests', () => {
  describe('EventInfo Management Component', () => {
    let comp: EventInfoComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(EventInfoComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.eventInfos && comp.eventInfos[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
